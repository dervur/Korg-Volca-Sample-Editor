function setPartData(data, part)
    ...
    -- If a Solo button is pressed set it to off before setting the part data
    local t={}
    t["Solo Part-1"] = 0
    t["Solo Part-2"] = 1
    t["Solo Part-3"] = 2
    ...
    for k,v in pairs(t)do
        ...
        if p==1 then
            ...
            solo_name = k
            solo_state = 1
		    console(solo_name.." was set to zero")
        end
    end
    ...
    if part==1 then
        ...
        modulator["Mute Part-1"] = 15
        modulator["Reverb Part-1"] = 16
    elseif part == 2 then
        ...
        modulator["Mute Part-2"] = 15
        modulator["Reverb Part-2"] = 16
    elseif part == 3 then
        ...
        modulator["Mute Part-3"] = 15
        modulator["Reverb Part-3"] = 16
    elseif part == 4 then
        ...
        modulator["Mute Part-4"] = 15
        modulator["Reverb Part-4"] = 16
    elseif part == 5 then
        ...
        modulator["Mute Part-5"] = 15
        modulator["Reverb Part-5"] = 16
    elseif part == 6 then
        ...
        modulator["Mute Part-6"] = 15
        modulator["Reverb Part-6"] = 16
    elseif part == 7 then
        ...
        modulator["Mute Part-7"] = 15
        modulator["Reverb Part-7"] = 16
    elseif part == 8 then
        ...
        modulator["Mute Part-8"] = 15
        modulator["Reverb Part-8"] = 16
    elseif part == 9 then
        ...
        modulator["Mute Part-9"] = 15
        modulator["Reverb Part-9"] = 16
    elseif part == 10 then
        ...
        modulator["Mute Part-10"] = 15
        modulator["Reverb Part-10"] = 16
    end    
    ...
    -- Set the solo button that was ON to on state
    if solo_state==1 then
	    panel:getModulatorByName(solo_name):setValue(1, true)
		console(solo_name.." was set to one")
    end
