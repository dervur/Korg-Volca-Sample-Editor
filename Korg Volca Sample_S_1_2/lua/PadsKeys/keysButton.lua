...
keysButton = function(--[[ CtrlrModulator --]] mod, --[[ number --]] value, --[[ number --]] source)
    ...
    if pads == 1 then
        ...
        panel:getModulatorByName("padPlayVelocity"):getComponent():setProperty("componentVisibility", 1, false)
    elseif keys == 1 then
        -- Show Keyboard parts
        ...
        panel:getModulatorByName("padPlayVelocity"):getComponent():setProperty("componentVisibility", 0, false)
